...
class ThanksForSubscribingScreen extends StatelessWidget {
  const ThanksForSubscribingScreen({required this.subscription, super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Gap(24),
              _SubscriptionInfoCard(subscription: subscription, locale: locale),
              const Gap(32),
              ElevatedButton(
                onPressed: () {
...
class _SubscriptionDetailItem extends StatelessWidget {
  const _SubscriptionDetailItem({required this.title, required this.value});
