...
class _$UiPredictionStateImpl implements _UiPredictionState {
  const _$UiPredictionStateImpl(
      ...
      this.dailyBudget = 0,
      this.isTaxFree = Envs.isAmountsTaxFree,
  ...
  @override
  String toString() {
    return 'UiPredictionState(selectedDate: $selectedDate, period: $period, totalExpensesSum: $totalExpensesSum, totalIncomesSum: $totalIncomesSum, oneTimeIncomesSum: $oneTimeIncomesSum, oneTimeExpensesSum: $oneTimeExpensesSum, dailyBudget: $dailyBudget, isTaxFree: $isTaxFree, countWithTransfers: $countWithTransfers, taskType: $taskType)';
  }
...
abstract class _UiPredictionState implements UiPredictionState {
  const factory _UiPredictionState(
      ...
      final bool isTaxFree,
      final bool countWithTransfers,
      final TaskType taskType}) = _$UiPredictionStateImpl;
