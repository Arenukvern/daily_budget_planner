...
/// {@endtemplate}
abstract class ManualBudgetsLocalApi extends ComplexLocalApi {
  ...
  Future<void> upsertBudget(final Budget budget);
  //  async {
  // try {
  ...
  ///
  /// Throws [LocalApiException] if the operation fails
  Future<void> deleteBudget(final BudgetId id);
  //  async {
  // try {
  //   isar.write((final db) {
  ...
  /// Throws [LocalApiException] if the operation fails
  Future<Budget> getBudget(final BudgetId id);
  // async {
  // try {
