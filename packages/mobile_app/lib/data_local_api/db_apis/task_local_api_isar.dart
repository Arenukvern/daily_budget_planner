...
/// {@endtemplate}
abstract class TasksLocalApi extends ComplexLocalApi {
  ...
  Future<void> upsertTask(final Task task);
  //  async {
  //   try {
  //     isar.write((final db) {
  ...
  Future<void> upsertTasks(final List<Task> tasks);
  //  async {
  //   try {
  //     isar.write((final db) {
  ...
  /// Throws [LocalApiException] if the operation fails
  Future<Task> getTask(final TaskId id);
  //  async {
  //   try {
  ...
  Future<List<Task>> getIncomeTasks({required final TaskType taskType});
  // async {
  //   try {
  //     final tasks =
  //         _tasks
  ...
  Future<List<Task>> getExpenseTasks({required final TaskType taskType});
  //  async {
  //   try {
  //     final tasks =
  //         _tasks
