...
abstract class ScheduledTransactionsLocalApi extends ComplexLocalApi {
  ...
  ///
  /// Throws [LocalApiException] if the operation fails
  Future<void> deleteScheduledTransaction(final TransactionId id);
  // async {
  //   try {
  //     isar.write((final db) {
  ...
  /// Throws [LocalApiException] if the operation fails
  Future<ScheduledTransaction> getScheduledTransaction(final TransactionId id);
  //  async {
  //   try {
  ...
  ///
  /// Throws [LocalApiException] if the operation fails
  Future<List<ScheduledTransaction>> getAllScheduledTransactions();
  //  async {
  //   try {
